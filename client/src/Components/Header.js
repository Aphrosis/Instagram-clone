...
import vid from "../9844-loading-40-paperplane.mp4";
import "./style.css";
const Header = () => {
  ...
  return (
    <>
      <form
        ...
        className="plus"
        style={{
          backgroundImage: img ? `url("${img}")  ` : "white",
          objectFit: "contain",
        }}
      >
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3NgUu3DYW5iTYE1To9-1EJiU2rivZumbpPw&usqp=CAU"
          alt=""
        />
        ...
        <video class="video" loop autoplay="true" src={vid}></video>
      </form>
      ...
      <div className="nav">
        ...
        <div className="icons">
          <i className="fa-1x fa-solid fa-house"></i>
          <i className="fa-1x fa-brands fa-facebook-messenger"></i>
          <i
            onClick={() => {
              show();
            }}
            className="fa-1x fa-solid fa-plus"
          ></i>
          <i className="fa-1x fa-solid fa-compass"></i>
          <i className="fa-1x fa-solid fa-heart"></i>
